  ...
  var persone = ["50 Cent","Abatantuono","Achille Lauro","Adani","Adinolfi",
  ...
  "Barrichello","Belen Rodriguez","Belle Delphine","Berlusconi",
  ...
  "Calcutta","Calvin Harris","Cannavacciuolo","Caparezza","Cardi B","Caressa",
  "Carlo Conti","Carlo Cracco","Carlo Verdone","Carlos Sainz","Carmen Consoli",
  "Carolina Crescentini","Casey Stoner","Castellitto",
  ...
  "Denzel Washington","Di Caprio","Diletta Leotta","Diodato","Dodi Battaglia",
  ...
  "Latifi","Laura Pausini","Le Vibrazioni","Leclerc","Lele Mora","Leonardo Pieraccioni",
  ...
  "Lucianina Littizzetto","Lucio Dalla","Luigi Di Maio","Luisa Ranieri","Lundini",
  "Lupo Alberto","Luxuria","Madonna","Madre Teresa","Mahmood","Malgioglio",
  ...
  "Maurizio Costanzo","Maurizio Crozza","Max Biaggi","Max Gazzè","Max Pezzali",
  "Max Verstappen","Megan Fox","Melissa Satta","Mentana","Michele Bravi","Michele Zarrillo",
  ...
  "Otelma","Ozzy Osbourne","Paola Turci","Paola e Chiara","Paolo Bonolis","Paolo Fox",
  ...
  "Romina Power","Rudy Zerbi","Sabaku No Maiku","Salmo","Salvini","Samantha Cristoforetti",
  ...
  "Zazzaroni","Zequila","Zerocalcare","Zio Paperone","Zucchero","il Dalai Lama","il Gabibbo","il Mago Forest",
  "il Mago Silvan","il Trio Medusa","il commissario Basettoni","la Meloni",
  "la Regina Elisabetta",];

  var personePlurale = ["Benji & Fede", "Castolo e Ximenes", "Fabio & Mingo",
